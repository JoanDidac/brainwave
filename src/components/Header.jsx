...
const Header = () => {
  const pathname = useLocation(); //Review the URl you're currently on

  return (
    <div
      className="fixed top-0 left-0 w-full z-50 bg-n-8/90 backdrop-blur-sm border-b
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav className="hidden top-[5rem] left-0 right-0 bottom-0 bg-n-8 lg:flex lg:mx-auto lg:bg-transparent">
